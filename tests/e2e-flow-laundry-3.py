...
def main():
    ...
    with make_browser() as p:
        ...
        page.get_by_role("button", name="Cài đặt").first.click(timeout=ACTION_TIMEOUT); page.wait_for_load_state("domcontentloaded", timeout=NAV_TIMEOUT); page.wait_for_timeout(1000)
        # 会员面板：手机号 → Tra cứu
